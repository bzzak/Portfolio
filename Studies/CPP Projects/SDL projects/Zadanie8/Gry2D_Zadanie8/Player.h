...
public:
	...
	virtual std::pair<float, float> move(int screenWidth, int screenHeight, float& cameraX, float& cameraY, float cX, bool& isCameraXLocked, float deltaTime, float smooth, float eps) = 0;
};
