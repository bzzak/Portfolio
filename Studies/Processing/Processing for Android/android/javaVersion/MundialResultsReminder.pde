...
XML database, groupElement;
XML[] groupsList;
ArrayList<ArrayList<ArrayList<Object>>> groupsData;
Group a, b, c;
...
public void setup()
{
  mundialBackground = loadImage("img/katar_background.jpeg");
  mundialBackground.resize(width, height);
  
  database = loadXML("data/database.xml");
  groupsList = database.getChildren();
  
  trophy = loadImage("img/trophy.png");
  
  netherlands = loadImage("img/flags/netherlands.png");
  senegal = loadImage("img/flags/senegal.png");
  equador = loadImage("img/flags/equador.png");
  quatar = loadImage("img/flags/quatar.png");
  
  england = loadImage("img/flags/england.png");
  usa = loadImage("img/flags/usa.png");
  iran = loadImage("img/flags/iran.png");
  wales = loadImage("img/flags/wales.png");
  
  argentina = loadImage("img/flags/argentina.png");
  poland = loadImage("img/flags/poland.png");
  mexico = loadImage("img/flags/mexico.png");
  saudi_arabia = loadImage("img/flags/saudi_arabia.png");
...
public void showLedderView()
{
  ...
  fill(220);
  text("Argentina World Champion 2022!", width / 2 , height / 2 + 0.3 * height );
